...
const Profile = ({imgSrc,fullName,bio,profession}) => {
    ...
    <Card  className="profile-card">
        ...
        <Card.Body>
            ...
            <Card.Text className='profession'>
            {profession}
            </Card.Text>
            <Button variant="primary" className='botn-style' onClick={Affiche} >Go somewhere</Button>
        </Card.Body>
    </Card>
...
Profile.defaultProps = {
    imgSrc:'https://i0.wp.com/researchictafrica.net/wp/wp-content/uploads/2016/10/default-profile-pic.jpg?ssl=1',
